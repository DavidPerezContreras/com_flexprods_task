  ...
  Widget build(BuildContext context) {
        ...
        return Scaffold(
          ...
          bottomNavigationBar: BottomNavigationBar(
            ...
            type: BottomNavigationBarType.fixed, // This will help in giving a neat look when you have more than 3 items
            ...
            selectedIconTheme: IconThemeData(size: 28), // This will give a slight zoom effect to the selected item's icon
          ),
        );
