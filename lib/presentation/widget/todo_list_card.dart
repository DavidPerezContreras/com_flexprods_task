...
class TodoListCard extends StatefulWidget {
  ...
  const TodoListCard({
    ...
    super.key, required this.onUpdate,
  });

  final Todo todo;
  final Function(Todo, bool) onIsCompleteChanged;
  final Function(Todo todo,{
...
class _TodoListCardState extends State<TodoListCard> {
  ...
  void initState() {
    super.initState();
    _topLevelNavigationProvider=Provider.of<TopLevelNavigationProvider>(context,listen:false);
          ...
          onTap: () {
            Navigator.of(_topLevelNavigationProvider
              ...
              MaterialPageRoute(
                builder: (context) =>
                    SaveTodoPage.update(
                      onUpdate: widget.onUpdate, todo: widget.todo,
                    ),
              ),
            )
